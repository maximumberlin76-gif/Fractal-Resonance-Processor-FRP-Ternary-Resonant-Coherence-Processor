...
The RTL interface contract defines the canonical signal interface between the FRP executable reference layer and RTL-facing processor workflow artifacts.
